...
const walletAddress = "0xE7019Ac0Ae5594BAB2473828CD279d2C9EEB218A"; // place your public address for your wallet here

async function main() {

  const token = await hre.ethers.getContractAt(tokenABI, tokenAddress);

  const tx = await token.mintCollection(walletAddress);
  await tx.wait();
